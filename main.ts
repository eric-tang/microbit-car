/*
Hunan Chuanglebo (clb) Intelligent Technology Co., Ltd.
Author: Zhu Lin
Date: 2020-01-11
*/
...
namespace makerobo {
    ...
    //% blockId=robotbit_setLeveL block="set sound sensor|%index|level %value"
    //% weight=99
    //% blockGap=50
    ...
    */
    ...
    //% blockId=Microbit_Sensor_IR block="infrared obstacle sensor|pin %pin|value %value"
    //% weight=96
    //% blockGap=20
    //% color="#228B22"
