/**
 * TM1650 4-digit display driver - vendored into this extension.
 *
 * Adapted from https://github.com/zhuning239/TM1650 (MIT License).
 * Copyright (c) 2020 zhuning239 - http://www.loborobot.com
 *
 * Block labels and comments were translated to English. All block IDs and
 * function names are unchanged, so existing programs keep working.
 */

/**
 * TM1650 digit Display
 */
//% weight=100 color=#64C800 icon="\uf1d5" block="clb 4-digit display"
namespace TM1650 {
    ...
    /**
     * show a digit in a given position
    ...
    /**
     * show Dot Point in a given position
     * @param bit is position, eg: 0
     * @param show is true/false, eg: true
     */
    //% blockId="TM650_SHOW_DP" block="show dot point %bit|visible %num"
    //% weight=80 blockGap=8
